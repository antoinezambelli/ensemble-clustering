...
class Ensemble():
    ...
    def generate_results(self, my_clust: Clustering, algo_selections: List[str]) -> Dict[str, List[Dict[str]]]:
    ...
    def __call__(
            ...
            e_params: Optional[Dict[str]]=None,
            algo_selections: Optional[List[str]]=None
        ) -> Union[Tuple[Dict[str, List[Dict[str]]], Dict[str]], Tuple[Dict[str, List[Dict[str]]], None]]:
        '''
