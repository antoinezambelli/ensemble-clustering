...
class E():
    def __init__(self, meta_res: List, param_perms: Dict[str, List[Dict[str]]]):
        '''
    ...
    def get_best_algo(self, ground_truth: int, single: bool) -> List[Tuple[str, Dict[str]]]:
    ...
    def __call__(self, e_params: Dict[str]) -> Dict[str]:
        E_res = {
            build: {
                vote: {
                    'num_clusters': []
